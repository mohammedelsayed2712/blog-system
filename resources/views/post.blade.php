            ...
            <div class="col-md-8">
                <div class="row row-pb-lg">
                    <div class="col-md-12 animate-box">
                        <div class="classes class-single">
                            <div class="classes-img" style="background-image: url(assets/images/classes-1.jpg);">
                            </div>
                ...
                <div class="row row-pb-lg animate-box">
                    <div class="col-md-12">
                        ...
                        <div class="review">
                            <div class="user-img" style="background-image: url(assets/images/person2.jpg)"></div>
                            <div class="desc">
                                <h4>
                                    <span class="text-left">Jacob Webb</span>
                                    <span class="text-right">24 March 2018</span>
                        ...
                        <div class="review">
                            <div class="user-img" style="background-image: url(assets/images/person3.jpg)"></div>
                            <div class="desc">
                                <h4>
                                    <span class="text-left">Jacob Webb</span>
                                    <span class="text-right">24 March 2018</span>
